...
import 'package:vire_glof/manager/League/edit_leagues.dart';
import 'package:vire_glof/manager/League/map_page.dart';
import 'package:vire_glof/res/commonWidgets.dart';

class ManagerLeagueDetailsScreen extends StatelessWidget {
  const ManagerLeagueDetailsScreen({super.key});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    commonButton(
                      "See on Map or Input Score",
                      onTap: () {
                        Get.to(ManagerMapScreen());
                      },
                    ),
                    const SizedBox(height: 24),
...
Future<void> showLogoutDialog(
  ...
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        title: commonText(
          "You want to delete your league, are you sure?",
          size: 18,
          textAlign: TextAlign.center,
        ),
