...
class ManagerOnboardingScreen3 extends StatelessWidget {
  const ManagerOnboardingScreen3({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              const FeatureCard(
                ...
                subtitle:
                    "Plan matches with ease and notify participants instantly.",
              ),
              ...
              const FeatureCard(
                ...
                subtitle:
                    "Invite and organize players for your leagues effortlessly.",
              ),
              const SizedBox(height: 12),
              const FeatureCard(
                ...
                subtitle:
                    "Gain insights with detailed stats to improve your events.",
              ),
