...
class ManagerLeaguesScoreboardPage extends StatelessWidget {
  const ManagerLeaguesScoreboardPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: commonText('League Scoreboard', isBold: true, size: 16),
        centerTitle: true,
        backgroundColor: Colors.white,
        elevation: 0,
      ),
