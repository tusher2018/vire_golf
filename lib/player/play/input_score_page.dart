...
class PlayerInputScorePage extends StatefulWidget {
  const PlayerInputScorePage({super.key});

  @override
  State<PlayerInputScorePage> createState() => _PlayerInputScorePageState();
}

class _PlayerInputScorePageState extends State<PlayerInputScorePage> {
