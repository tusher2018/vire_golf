...
class PlayerLeaderBoardPage extends StatefulWidget {
  const PlayerLeaderBoardPage({super.key});

  @override
  State<PlayerLeaderBoardPage> createState() => _PlayerLeaderBoardPageState();
}

class _PlayerLeaderBoardPageState extends State<PlayerLeaderBoardPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: PlayerScoreList()),
